...
- The expected default is 0 comments, not a starting position to argue up from. The two exceptions below are the entire set, and no reasoning, however good, produces a third.
